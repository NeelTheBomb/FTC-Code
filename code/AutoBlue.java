...
//             telemetry.addData("centerMedian ", centerMedian[0]);
...
//             telemetry.addData("finalcenter: ", center);
//             telemetry.addData("realCenter: ", realCenter);
//             telemetry.update();
//             if (realCenter == left_pos) {
//                 step = 2;
//             }   
//             else if (realCenter == middle_pos) {
//                 step = 6;
//             }
//             else if (realCenter == right_pos) {
//                 step = 8;
//             }
//         }
//         //left_pos movements
//         else if (step == 2) {
//             double beginningYPos = 480;
//             double beginningXPos = 0;
//             boolean posCheck = moveToPos(beginningXPos, beginningYPos, pastX, pastY);
//             if (posCheck) {
//                 step += 1;
...
//         }
//         else if (step == 3) {
//         //   boolean posCheck = turnLeft(100, 20); //100 is turn amount 
//         //   if (posCheck) {
//                 fl.setPower(0);
//                 bl.setPower(0);
//                 fr.setPower(0);
...
//         else if (step == 4) {
//             double beginningYPos = 480;
//             double beginningXPos = -330;
//             boolean posCheck = moveToPosTolerance(beginningXPos, beginningYPos, pastX, pastY, 30);
//             if (posCheck) {
//                 fl.setPower(0);
//                 bl.setPower(0);
//                 fr.setPower(0);
...
//             // if (Math.abs(intake.getTargetPosition() - intake.getCurrentPosition()) <= tolerance) {
//             //     posCheck = true;
//             // }
//             if (posCheck) {
//                 stop();
...
//         //right_pos movements
//         else if (step == 8) {
//             double beginningYPos = 400;
//             double beginningXPos = 320;
//             boolean posCheck = moveToPos(beginningXPos, beginningYPos, pastX, pastY);
//             if (posCheck) {
//                 step += 1;
//             } 
...
//         return ((Math.abs(pastX - targetPosX) <= tolerance) && Math.abs(pastY - targetPosY) <= tolerance);
//     }
    
//     private boolean moveToPosTolerance(double targetPosX, double targetPosY, double pastX, double pastY, double tolerance) {
//         double[] moveConstants = desiredVector(pastX, pastY, targetPosX, targetPosY, 60);
//         telemetry.addData("moveX", moveConstants[0]);
//         telemetry.addData("moveY", moveConstants[1]);  
//         telemetry.addData("turn", -imu.getAngularOrientation().firstAngle); 
